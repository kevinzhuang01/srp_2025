...
degrees: BS in Computer Science (2023), MS in Computer Science (2026)
courses: 'MS in CS (Georgia Tech): AI, AI for Robotics, NLP, Software Dev Process,
  HCI, Machine Learning for Sensor-Based Human Activity Recognition Seminar BS in
  CS (Oregon State): Data Structures, Algorithms, Databases, Networks, OS, Parallel
  Programming'
research_experience: 'CLEF 2025 - CheckThat! lab for Task 1 Paper title: Detecting
  Subjectivity via Transfer-Learning and Corrective Data Augmentation Georgia Tech
  VIP - Health Informatics on FHIR Project'
academic_interests: AI and data science applied to high-performance computing, large
  datasets, sensor and imaging systems, and computationally intensive, data-driven
  projects.
