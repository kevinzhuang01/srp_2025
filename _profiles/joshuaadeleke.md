...
last_name: Adeleke
name: Joshua Adeleke
email: jadeleke@hawk.illinoistech.edu
...
degrees: Ph.D./Applied Mathematics/2027 M.Sc./Mathematical Engineering/2022 B.Sc./Physics/2016
courses: I have completed a rigorous blend of graduate-level mathematics and computational
  courses that directly support a research-focused summer internship. Core coursework
  includes Partial Differential Equations, Functional Analysis, Measure Theory, and
  Applied Analysis, which built my foundation in modeling, proof techniques, and analytical
  problem solving. On the computational side, I have taken Parallel Computing and
  Numerical Methods, Machine Learning, and High-Performance Computing seminars, where
  I gained experience with Python, MATLAB, and numerical linear algebra for large-scale
  simulations.
academic_interests: My research centers on analysis and partial differential equations,
  with a focus on measure-theoretic scalar balance laws and Lie symmetry methods for
  nonlinear PDEs. I am particularly interested in how symmetry structures and entropy
  principles govern the existence, uniqueness, and qualitative behavior of weak solutions
